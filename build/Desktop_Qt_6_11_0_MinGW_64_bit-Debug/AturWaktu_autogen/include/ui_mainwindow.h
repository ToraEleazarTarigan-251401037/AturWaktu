...
"   "));
        ...
        lineEditAlarmTitle = new QLineEdit(tabAlarm);
        lineEditAlarmTitle->setObjectName("lineEditAlarmTitle");

        alarmListVLayout->addWidget(lineEditAlarmTitle);
        ...
        dateEditAlarm->setDateTime(QDateTime(QDate(2025, 12, 31), QTime(10, 0, 0)));
        ...
        QBrush brush1(QColor(43, 11, 37, 255));
        brush1.setStyle(Qt::BrushStyle::SolidPattern);
        palette.setBrush(QPalette::ColorGroup::Active, QPalette::ColorRole::Button, brush1);
        QBrush brush2(QColor(64, 16, 55, 255));
        brush2.setStyle(Qt::BrushStyle::SolidPattern);
        palette.setBrush(QPalette::ColorGroup::Active, QPalette::ColorRole::Light, brush2);
        QBrush brush3(QColor(53, 13, 46, 255));
        brush3.setStyle(Qt::BrushStyle::SolidPattern);
        palette.setBrush(QPalette::ColorGroup::Active, QPalette::ColorRole::Midlight, brush3);
        QBrush brush4(QColor(21, 5, 18, 255));
        brush4.setStyle(Qt::BrushStyle::SolidPattern);
        palette.setBrush(QPalette::ColorGroup::Active, QPalette::ColorRole::Dark, brush4);
        QBrush brush5(QColor(29, 7, 25, 255));
        ...
        palette.setBrush(QPalette::ColorGroup::Disabled, QPalette::ColorRole::Highlight, brush6);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lineEditAlarmTitle->setPlaceholderText(QCoreApplication::translate("MainWindow", "Masukkan judul alarm...", nullptr));
